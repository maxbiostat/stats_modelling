...
Vamos raciocinar sobre algumas quantidades, a saber a média ($\sM$) e a mediana ($\hat{M}$) amostrais. Em particular, vamos pensar sobre como construir intervalos de confiança para essas quantidades.
